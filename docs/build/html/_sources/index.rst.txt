...
$project includes a wrapper and a set of tools for [Nanograv's Enterprise](https://github.com/nanograv/enterprise/).
...
Install $project by:
        ...
        git clone https://github.com/bvgoncharov/enterprise_warp.git
        cd enterprise_warp
